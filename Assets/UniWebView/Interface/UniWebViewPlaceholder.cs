...
public class UniWebViewInterface
{
    ...
    public static bool AnimateTo(string name, int x, int y, int width, int height, float duration, float delay,
        string identifier)
    {
        CheckPlatform();
        return false;
    ...
    public static void CheckPlatform()
    {
        if (!alreadyLoggedWarning)
        {
            ...
            Debug.LogWarning("UniWebView only supports iOS/Android/macOS Editor. You current platform " +
